...
public class TVShowsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TVShowsRecyclerAdapter(RecyclerView recyclerView, List<TVShow> data, Activity activity) {
        this.data = data;
