 ...
 */
public class CastAdapter2 extends RecyclerView.Adapter<CastAdapter2.MyViewHolder> {
    ...
    public CastAdapter2(Context mContext, List<Cast> castList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cast_item2, parent, false);
