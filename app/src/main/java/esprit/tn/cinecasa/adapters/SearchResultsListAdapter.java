...
public class SearchResultsListAdapter extends RecyclerView.Adapter<SearchResultsListAdapter.ViewHolder> {
    ...
    private List<MultiSearch> mDataSet = new ArrayList<>();

    private int mLastAnimatedItemPosition = -1;

    public interface OnItemClickListener{
        void onClick(MultiSearch colorWrapper);
    }
    ...
    public void swapData(List<MultiSearch> mNewDataSet) {
...
//        MultiSearch colorSuggestion = mDataSet.get(position);
