...
public class CombinedCrediDetails extends Fragment {
    ...
    private static String TAG = CombinedCrediDetails.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        currentPage = (TextView) view.findViewById(R.id.current_pagee);
        allPages = (TextView) view.findViewById(R.id.all_pagess);
        ...
        urlJsonObj = "https://api.themoviedb.org/3/person/" + id + "/movie_credits?api_key=7c408d3e3e9aec97d01604333744b592&language=en-US";
        return view;
    }
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < results.length() - 1; i++) {
                        ...
                        final Movie movie1 = new Movie(null, id, false, vote_average, title, null, poster_path, null, null, null, false, null, null, null);
